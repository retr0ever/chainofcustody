"""Orchestrate the full 5-metric scoring pipeline over a parsed mRNA sequence."""
...
def score_parsed(
    ...
    """Run all 5 evaluation metrics on an already-parsed mRNA sequence.
    ...
    Returns:
        ...
        ``structure_scores``, ``manufacturing_scores``, ``stability_scores``,
        ``summary``.
    """
